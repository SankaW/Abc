...
namespace SW01.Data
{
    ...
    public partial class SW01Entities : DbContext
    {
        public SW01Entities()
            : base("name=SW01Entities")
        {
        }
        ...
        public virtual DbSet<aspnet_NewProfile> aspnet_NewProfile { get; set; }
        ...
        public virtual DbSet<CVCreate> CVCreates { get; set; }
        public virtual DbSet<Department> Departments { get; set; }
        public virtual DbSet<Group> Groups { get; set; }
        public virtual DbSet<Product> Products { get; set; }
        public virtual DbSet<Tax> Taxes { get; set; }
        public virtual DbSet<Vehicle> Vehicles { get; set; }
        public virtual DbSet<LastSixMonthsanalisiReorder> LastSixMonthsanalisiReorders { get; set; }
        public virtual DbSet<ProductAgeAnalysi> ProductAgeAnalysis { get; set; }
        public virtual DbSet<ProductAgelocation> ProductAgelocations { get; set; }
        public virtual DbSet<View_StockAdj> View_StockAdj { get; set; }
        ...
        public virtual DbSet<VW_BINCARD> VW_BINCARD { get; set; }
        public virtual DbSet<VW_LOCATIONWISERPT> VW_LOCATIONWISERPT { get; set; }
        public virtual DbSet<VW_PRODUCTWISERPT> VW_PRODUCTWISERPT { get; set; }
        ...
        public virtual int BinCard(Nullable<int> productId, Nullable<int> location_ToId)
        {
            var productIdParameter = productId.HasValue ?
                new ObjectParameter("ProductId", productId) :
                new ObjectParameter("ProductId", typeof(int));
    
            var location_ToIdParameter = location_ToId.HasValue ?
                new ObjectParameter("Location_ToId", location_ToId) :
                new ObjectParameter("Location_ToId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("BinCard", productIdParameter, location_ToIdParameter);
        }
    
        public virtual ObjectResult<GetBinCardValues_Result> GetBinCardValues(string userID, string itemCode, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetBinCardValues_Result>("GetBinCardValues", userIDParameter, itemCodeParameter, startDateParameter, endDateParameter);
        }
